function Computer() {
    ...
    this.processes = [
        ...
        { //Buy Ice
            ...
            cost:0,
            costType:"",
            finish:function() { game.buyIce(70) },
            showing: function() { return true; }
        },
        { //Sell Water
            currentTicks: 0,
            ...
            cost:0,
            costType:"",
            finish:function() { game.water.sellWater(35) },
            showing: function() { return true; }
        },
        { //Improve Farms
            currentTicks: 0,
            ...
            cost:0,
            costType:"",
            finish:function() { game.farms.improve(); this.ticksNeeded = precision3(4*(this.completions+2 )+ Math.pow(this.completions, 2)/10); },
            showing: function() { return true; }
        },
        { //Find more Ice Sellers
            ...
            cost: .25,
            costType:"cash",
            finish:function() { game.ice.findIceSeller(8) },
            showing: function() { return true; }
        },
        { //Bigger Storms
            currentTicks: 0,
            ...
            cost: 1.2,
            costType:"science",
            finish:function() { game.clouds.gainStormDuration(35); this.cost += .3; this.ticksNeeded += 20; },
            done:function() { return game.clouds.initialStormDuration >= 30000; },
            showing: function() { return true; }
        },
        { //Build Robots
            currentTicks: 0,
        ...
        { //Improve House Design
            ...
            cost:.5,
            costType:"wood",
            finish:function() { game.population.improveHouse(); this.ticksNeeded += 200; },
            showing: function() { return game.robots.unlocked; },
