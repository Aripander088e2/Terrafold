function Robots() {
    ...
    this.jobs = [
        ...
        { //Build Mines
            ...
            cost:[0.2],
            costType:["wood"],
            finish: function() { game.robots.mines++; this.ticksNeeded += 3; this.cost[0] = precision3(.003 * this.completions + Math.pow(this.completions, 2)/500); },
            done: function() { return game.robots.mines*100 >= game.land.optimizedLand; },
            showing: function() { return true; }
        },
        { //Mine Ore
            workers:0,
